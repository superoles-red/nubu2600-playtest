...
const CACHE_NAME = `${CACHE_PREFIX}1fbcff88c65232d7`;
...
const CORE_PRECACHE_ENTRIES = PRECACHE_ENTRIES.filter(entry => !entry.url.includes('/editor/campaign/')
  || entry.url.includes('/editor/campaign/ep1/ep1-01-'));
